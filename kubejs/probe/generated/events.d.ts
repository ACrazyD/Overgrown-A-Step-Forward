...
declare function onForgeEvent(name: "dynamiclabs.immersivefx.sndctrl.events.AudioEvent$MusicFadeAudioEvent", handler: (event: Internal.AudioEvent$MusicFadeAudioEvent) => void);
...
declare function onForgeEvent(name: "dynamiclabs.immersivefx.lib.events.BlockUpdateEvent", handler: (event: Internal.BlockUpdateEvent) => void);
